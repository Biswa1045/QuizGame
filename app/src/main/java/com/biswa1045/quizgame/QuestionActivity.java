...
import static com.biswa1045.quizgame.SetsActivity.setsIDs;
...
public class QuestionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView = new AdView(this, "278968300447510_278975473780126", AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer = (LinearLayout) findViewById(R.id.adView4);
...
intent.putExtra("QUESTION",questionList.size());
